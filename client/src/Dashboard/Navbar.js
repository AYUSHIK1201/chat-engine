...
<nav className="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <Userimage src={userinfo.oauth===true?userinfo.loginStatus.user.photoURL:`http://localhost:5000/${userinfo.loginStatus.profile_photo}`} />
  <Username>{userinfo.oauth===true?userinfo.loginStatus.user.displayName:userinfo.loginStatus.display_name}</Username>
